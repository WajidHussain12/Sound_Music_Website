...
if (isset($_POST['livesearch'])) {
  ...
  // $sql = "SELECT * FROM song_table WHERE Song_Name  LIKE '{$search_term}%' AND Song_Category = 'bollywood';";
  // $sql = "SELECT * FROM song_table WHERE CONCAT(Song_Name, ' ', Artist_Name, ' ', Album_Name, ' ', Film_Name, ' ', Song_TimeDuration, ' ', Year) LIKE '{$search_term}%' AND Song_Category = 'bollywood'";
  $sql = "SELECT * FROM song_table
  WHERE (Song_Name LIKE '%{$search_term}%' OR
         Artist_Name LIKE '%{$search_term}%' OR
         Album_Name LIKE '%{$search_term}%' OR
         Film_Name LIKE '%{$search_term}%' OR
         Song_TimeDuration LIKE '%{$search_term}%' OR
         Year LIKE '%{$search_term}%')
  AND Song_Category = 'bollywood'";
